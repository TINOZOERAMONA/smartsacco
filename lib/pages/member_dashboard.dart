...
//   // Future<void> _showLoanApplication() async {
...
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:smartsacco/models/transaction_repository.dart';
import 'package:smartsacco/pages/loan.dart';
import 'package:smartsacco/models/notification.dart';
import 'package:smartsacco/pages/loanapplication.dart';
import 'package:smartsacco/models/momopayment.dart';
  ...
  final result = await Navigator.push(
    ...
    MaterialPageRoute(
      builder: (context) => LoanApplicationScreen(
        ...
        memberSavings: _currentSavings, 
        onSubmit: (Map<String, dynamic> application ) async{ 
          try{
            await FirebaseFirestore.instance
            .collection('users')
                .doc(memberId)
...
//             }
//           }, userProfile: {
//             'fullName': 'User Full Name',  // Replace with actual user data
//             'phoneNumber': '775123456',
//           },
//         ),
      
//        // Now passing the required parameter
//     ),
...
void _makePayment(Loan loan) async {
            ...
            try {
              ...
              final paymentRef = await FirebaseFirestore.instance
                  ...
                  .add({
                    ...
                    'payerPhone': userProfile['phoneNumber'],
                  });
  ...
  Navigator.push(
    ...
    MaterialPageRoute(
      builder: (context) => MomoPaymentPage(
        ...
        userProfile: {
          'fullName': 'User Full Name',  // Replace with actual user data
          'phoneNumber': '775123456',    // Replace with actual user data
        },
      ),
    ),
  );
