...
//   isEmailStep = true;
//   await flutterTts.speak("Welcome to SmartSacco login. Please say your email address slowly.");

//   await Future.delayed(Duration(seconds: 4));
//   _startListening();
// }

//   Future<void> _processEmailInput(String input) async {
//     spokenEmail = input.toLowerCase()
//         .replaceAll(' at ', '@')
//         .replaceAll(' dot ', '.')
//         .replaceAll(' ', '');
//     _logger.info("Processed email: $spokenEmail");

//     await flutterTts.speak("Thank you. Now please say your 6 digit PIN, one digit at a time.");

//     // Wait for TTS to finish speaking, then start listening
//     // flutterTts.awaitSpeakCompletion = true; // recommended if available

//     isEmailStep = false;

//     // Small delay to allow TTS engine to release audio focus
...
//     String message = "Welcome to SmartSacco login! Please say your 6-digit PIN one digit at a time.";
...
//               speech.stop();
//               if (isEmailStep) {
//                 _processEmailInput(val.recognizedWords);
//               } else {
...
//       QuerySnapshot querySnapshot = await _firestore
//           .collection('users')
//           .where('email', isEqualTo: spokenEmail) // ✅ use spokenEmail
//           .where('pin', isEqualTo: pin)
//           .limit(1)
//           .get();
...
//             await flutterTts.speak("Account found, but automatic login failed. Please contact your administrator.");
//             return;
//           }
//         }
...
//             Navigator.pushReplacementNamed(
//               context,
//               '/blindmember', // or use role-based logic if needed
//               arguments: userData,
//             );
//           }
//         });
